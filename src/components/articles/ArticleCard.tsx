...
export default function ArticleCard({ article }: ArticleCardProps) {
  ...
  return (
    <article className="bg-surface rounded-lg border border-border overflow-hidden hover:border-border-dark transition-colors group">
      ...
      <div className="p-5">
        ...
        <Link to={`/article/${article.slug}`}>
          <h3 className="text-[15px] font-bold text-dark leading-relaxed mb-2 group-hover:text-accent-dark transition-colors line-clamp-2">
            {article.title}
          </h3>
        </Link>
